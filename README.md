...
current   : AI Workflow Engineer @ Wayfair
awards    : 🏆 Experian Best Unique & Innovative Idea Award
shipped   : 50,000+ users across production apps
languages : Dart · JavaScript · Python · Go · SQL · Java
interests : AI Agents · Autonomous Pipelines · Full-Stack · Real-Time Systems
pronouns  : He / His
```
...
**🤖 AI Agent Pipeline @ Wayfair**
Architected a 4-agent autonomous system in n8n using Google Gemini & Mistral AI — cutting trend research from days to minutes across 3+ data sources.

  </td>
    <td valign="top" width="50%">

**📱 Eternia — 50K+ Users**
Led end-to-end Flutter development for an enterprise B2B app with role-based auth for customers, dealers, and admins across a national partner network.
...
Built a live AI credit-decisioning solution with alternative data pipelines, expanding financial access for 24M underserved users. Demoed to Experian leadership.

  </td>
    <td valign="top">

**🧘 Swastha AI — Mental Wellness Platform**
Full-stack platform with Node.js, Next.js & AWS — offline journaling, LLM triage, therapist booking, and secure audio/video sessions.
...
![Google Gemini](https://img.shields.io/badge/Gemini_AI-%234285F4.svg?style=flat-square&logo=google&logoColor=white)
![Mistral AI](https://img.shields.io/badge/Mistral_AI-%23FF7000.svg?style=flat-square&logoColor=white)
![LLM Integration](https://img.shields.io/badge/LLM_Integration-%236C63FF.svg?style=flat-square&logoColor=white)
...
![WebSocket](https://img.shields.io/badge/WebSockets-%236C63FF.svg?style=flat-square&logoColor=white)
